  ...
  const slides = [
    {
      ...
      content: (
        <div className="text-center">
          <h2 className="text-4xl font-bold mb-4">Unread Messages</h2>
          <motion.div
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
          ...
          <p className="mt-4 text-xl">new messages waiting for you!</p>
        </div>
      ),
    },
    {
      id: 2,
      content: <div className="text-3xl font-bold">Placeholder Slide 2</div>,
    },
    {
      id: 3,
      content: <div className="text-3xl font-bold">Placeholder Slide 3</div>,
    },
  ];
